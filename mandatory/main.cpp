...
/*   Updated: 2024/09/01 04:11:42 by oredoine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void printIntro() 
{
	...
	std::cout << green;
	std::cout << "   _   _        __        __   _                            __  __       _    _      _     _  " << std::endl;
    std::cout << "  | \\ | | ___   \\ \\      / /__| | ___ ___  _ __ ___   ___  |  \\/  | __ _| |_ (_) ___| |__ (_) " << std::endl;
    std::cout << "  |  \\| |/ _ \\   \\ \\ /\\ / / _ \\ |/ __/ _ \\| '_ ` _ \\ / _ \\ | |\\/| |/ _` | __|| |/ __| '_ \\| | " << std::endl;
    std::cout << "  | |\\  | (_) |   \\ V  V /  __/ | (_| (_) | | | | | |  __/ | |  | | (_| | |_ | | (__| | | | | " << std::endl;
    std::cout << "  |_| \\_|\\___/     \\_/\\_/ \\___|_|\\___\\___/|_| |_| |_|\\___| |_|  |_|\\__,_|\\__|/ |\\___|_| |_|_| " << std::endl;
